	...
	<div class="storybook-header">
		...
		<div>
			{#if user}
				...
				<ButtonDemo size="small" on:click={onLogout} label="Log out" />
			{:else}
				<ButtonDemo size="small" on:click={onLogin} label="Log in" />
				<ButtonDemo primary size="small" on:click={onCreateAccount} label="Sign up" />
			{/if}
		</div>
	</div>
</header>
